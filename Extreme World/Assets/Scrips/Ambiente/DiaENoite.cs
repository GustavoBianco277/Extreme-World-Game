...
public class DiaENoite : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            RenderSettings.ambientSkyColor = componenteLuz.color * Mathf.Clamp(intensidadeCor, 0.0f, 1.0f);
            RenderSettings.ambientIntensity = Mathf.Lerp(RenderSettings.ambientIntensity, 1.0f, Time.deltaTime * ConfigsDoDia.VelocidadeInteracao);
            RenderSettings.reflectionIntensity = Mathf.Lerp(RenderSettings.reflectionIntensity, 1.0f, Time.deltaTime * ConfigsDoDia.VelocidadeInteracao);
            componenteLuz.intensity = Mathf.Lerp(componenteLuz.intensity, 0.51f, Time.deltaTime * ConfigsDoDia.VelocidadeInteracao);
        }
        ...
        if (componenteLuz.intensity > ConfigsDoDia.maxIntensity)
            componenteLuz.intensity = ConfigsDoDia.maxIntensity;
    }
